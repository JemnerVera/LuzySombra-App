...
9. Min (% Luz) - desde `evalImagen.AnalisisImagen` en ***REMOVED***
10. Max (% Luz) - desde `evalImagen.AnalisisImagen` en ***REMOVED***
11. Prom (% Luz) - desde `evalImagen.AnalisisImagen` en ***REMOVED***
12. Min (% Sombra) - desde `evalImagen.AnalisisImagen` en ***REMOVED***
13. Max (% Sombra) - desde `evalImagen.AnalisisImagen` en ***REMOVED***
14. Prom (% Sombra) - desde `evalImagen.AnalisisImagen` en ***REMOVED***
