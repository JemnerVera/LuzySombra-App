...
**Base de Datos:** `***REMOVED***` (Servidor: configurar en `.env.local`)  
...
9. Min (% Luz) - desde `image.Analisis_Imagen` en ***REMOVED***
10. Max (% Luz) - desde `image.Analisis_Imagen` en ***REMOVED***
11. Prom (% Luz) - desde `image.Analisis_Imagen` en ***REMOVED***
12. Min (% Sombra) - desde `image.Analisis_Imagen` en ***REMOVED***
13. Max (% Sombra) - desde `image.Analisis_Imagen` en ***REMOVED***
14. Prom (% Sombra) - desde `image.Analisis_Imagen` en ***REMOVED***
...
1. **Acceso de Lectura y Escritura**: 
   ...
   - Escritura: Usuario `***REMOVED***` (`INSERT`/`UPDATE` en `image.Analisis_Imagen`)
...
3. **Estrategia Implementada**:
   ...
   - Todas las tablas en la misma base de datos `***REMOVED***`
