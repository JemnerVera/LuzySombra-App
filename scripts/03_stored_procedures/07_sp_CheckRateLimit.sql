-- =====================================================
-- SCRIPT: Crear Stored Procedure evalImagen.sp_CheckRateLimit
...
IF EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'evalImagen.sp_CheckRateLimit') AND type in (N'P', N'PC'))
    DROP PROCEDURE evalImagen.sp_CheckRateLimit;
GO

CREATE PROCEDURE evalImagen.sp_CheckRateLimit
...
EXEC sys.sp_addextendedproperty 
    ...
    @level1type = N'PROCEDURE', @level1name = N'sp_CheckRateLimit';
GO

PRINT '[OK] Stored Procedure evalImagen.sp_CheckRateLimit creado exitosamente';
GO
